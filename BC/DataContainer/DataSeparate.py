...
if __name__ == '__main__':
    ...
    container = DataContainer()
    # 数据加载路径
    # container.Load(r'D:\data\4\1-4features.csv')
    # # 数据输出路径
    # output_path = r'D:\data\4'
    # # ？？？
    # clinical_path = r'D:\data\4\1-4features.csv'
    container.Load(r'D:\data\fenci.csv')
    # 数据输出路径
    output_path = r'D:\data'
    # ？？？
    clinical_path = r'D:\data\fenci.csv'
    # 方差计算后进行可视化保存
    #cluster_split.VisualizePartsVariance(container, store_folder=output_path)
    # 训练集和测试集划分: 输出split_info.csv、test.csv、train.csv文件
    cluster_split.Run(container, output_path)
    # 配置文件参数: Check config path:D:\FAE-master\BC\DataContainer\BC\HyperParameters\RandomSeed.json
