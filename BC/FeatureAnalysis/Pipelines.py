...
if __name__ == '__main__':
    ...
    train = DataContainer()
    test = DataContainer()
    train.Load(r'D:\FAE-master\Example\train.csv')
    test.Load(r'D:\FAE-master\Example\test.csv')

    faps = PipelinesManager(balancer=index_dict.GetInstantByIndex('DownSampling'),
    ...
    #     print(total, num)
    for total, num, group in faps.RunWithCV(train, store_folder=r'D:\FAE-master\Example'):
        print(total, num, group)
    for total, num in faps.MergeCvResult(store_folder=r'D:\FAE-master\Example'):
        print(total, num)
